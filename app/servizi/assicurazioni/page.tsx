...
import { Shield, Heart, Plane, Car, Home, Phone, CheckCircle, X, AlertTriangle, CreditCard, FileText, Users, Clock, ArrowRight, Star, Briefcase, MapPin } from 'lucide-react'
...
const testimonials = [
  {
    ...
    plan: 'Completa',
    rating: 5,
    comment: 'Grazie all\'assicurazione ho evitato spese enormi quando mio figlio si è rotto il braccio a Marrakech. Assistenza impeccabile e rimborso veloce.',
  ...
  },
  {
    ...
    plan: 'Premium',
    rating: 5,
    comment: 'Vol annulé à cause d\'une grève, l\'assurance a couvert tous les frais d\'hôtel et de repas. Service client très réactif.',
...
const faqData = [
  {
    ...
    answer: 'Ti consigliamo di acquistare l\'assicurazione entro 7 giorni dalla prenotazione del viaggio per avere la copertura completa per l\'annullamento.'
  },
  {
    question: 'Cosa fare in caso di emergenza?',
    answer: 'Contatta immediatamente il nostro numero di emergenza 24/7: +39 800 123 456. Il nostro team ti assisterà in italiano e organizzerà l\'intervento necessario.'
  },
  {
    question: 'Come richiedere un rimborso?',
    answer: 'Puoi richiedere il rimborso online tramite il nostro portale, allegando tutta la documentazione necessaria. I rimborsi vengono elaborati entro 15 giorni lavorativi.'
  },
  {
    question: 'Le attività sportive sono coperte?',
    answer: 'Le attività sportive ricreative sono incluse nei piani Completa e Premium. Per sport estremi è necessaria una copertura aggiuntiva.'
  }
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 dark:from-blue-900/30 dark:to-cyan-900/30" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              Viaggia in Marocco con la massima tranquillità. Protezione completa per te e la tua famiglia 
              con coperture fino a €200.000 e assistenza 24/7 in italiano.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Protezione completa per ogni aspetto del tuo viaggio
            </p>
          </div>
